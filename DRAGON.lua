...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/YUUIS5F/YUUIS5F/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1785825545,1860114886,1785825545,1602536224,916165019}   
...
os.execute('wget https://raw.githubusercontent.com/YUUIS5F/YUUIS5F/main/DRAGON.lua')
...
local Text ='🐣╖⁩ مرحبا بك في سورس همس\n💎╢ انت هنا المطور الاساسي\n🎗️╢ يمكنك التحكم فالبوت من الازار \n🦠╜ سورس همس الاول عل التلجرام\n'
keyboard = {} 
keyboard.inline_keyboard = {
...
send(msg.chat_id_, msg.id_,' • احدث اصدار من سورس همس ')
end
...
local Text = [[
[𝕊𝕆𝕌ℝℂ𝔼 ℍ𝕄𝕊](t.me/hms_00)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' 𝙷ٍْ𝙼ٍْ𝚂ْ 𓃠', url="t.me/hms_01"}},
{{text = '𝕊𝕆𝕌ℝℂ𝔼 ℍ𝕄𝕊', url="t.me/hms_00"}},
{{text = 'اضف البوت لمجموعتك ' ,url="t.me/"..dofile("./sexInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/U_AFLAM/71&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/U_AFLAM/58&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
◉ ادعيه ← لعرض الميزه
◉ الاذان  ← لعرض الميزه
◉ اسئله دينيه   ← لعرض الميزه
◉ اسلاميات ← لعرض الميزه
◉  نسبه الحب ← لعرض الميزه
◉ نسبه الكره ← لعرض الميزه
◉ عقاب  ← لعرض الميزه
◉ كشف الكذب ← لعرض الميزه
◉ العاب السورس ← لعرض الميزه
◉ اسئله  ← لعرض الميزه
◉ تحليل ← لعرض الميزه
◉ مهنتي  ← لعرض الميزه
◉ مستقبلي ← لعرض الميزه
...
◉ تصميم← لعرض الميزه
◉ ثيم ← لعرض الميزه
◉ اسكرينات← لعرض الميزه
◉ نكته ← لعرض الميزه
◉ نكته بصوره + اسمك ← لعرض الميزه
◉ صراحه  ← لعرض الميزه
◉ تويت ← لعرض الميزه
◉ لو خيروك  ← لعرض الميزه
◉ لو خيروك بصوره  ← لعرض الميزه
◉ حروف← لعرض الميزه
◉ حروف بصوره  ← لعرض الميزه
◉ افلام← لعرض الميزه
◉ مسلسلات ← لعرض الميزه
◉ اغاني  ← لعرض الميزه
◉  كارتون← لعرض الميزه
...
◉ انمي  ← لعرض الميزه
◉ صور رعب ← لعرض الميزه
◉ احداث حقيقيه← لعرض الميزه
◉  قصص رعب ← لعرض الميزه
◉  المسابقه ← لعرض الميزه
◉ الحذف  ← لعرض الميزه
◉ التيك توك  ← لعرض الميزه
◉ اليوتيوب  ← لعرض الميزه
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
◉ [𝙷ٍْ𝙼ٍْ𝚂ْ 𓃠 ](t.me/hms_00) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  اضف البوت لمجموعتك ✅ 𖠕 ',url="t.me/"..dofile("./sexInfo.lua").botUserName.."?startgroup=start"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/U_AFLAM/74&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
{{text = '𝑺𝑶𝑼𝑹𝑪𝑬 𝑯𝑴𝑺 𓏴  ', url="t.me/hms_00"}},
}
local msg_id = msg.id_/2097152/0.5
...
local Text = [[
 همس مطور السورس لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/U_AFLAM/54&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/YUUIS5F/YUUIS5F/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/YUUIS5F/YUUIS5F/main/File_Bot/"..file)
if res == 200 then
...
---------
if text == ("رفع بقلب همس") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل من قلب همس")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n • الـعـضو  ← ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n • تم تنزيل العضو من قلب همس بنجاح\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, t..'☩━━━━━ ♔... « 𝙷𝙼𝚂 » ...♔ ━━━━━☩\nاضغط علي الاسم ليتم نسخه\n☩━━━━━ ♔... « 𝙷𝙼𝚂 » ...♔ ━━━━━☩ٴ\n • [♔... « 𝙷𝙼𝚂 » ...♔](t.me/hms_00) • ')
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/BABLO_DV/41&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙋𝙊??𝙂𝙀 ', url="t.me/hms_00"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/BABLO_DV/42&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, ' صلي ع النبي ﷺ ') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, ' صلي ع النبي ﷺ  ..⛓️💕') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '◉ همس ورب العباد') 
return false
end
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"لف يبنلوسخه","متيجي انيقق ياات","لف","اقلعع يبنلوسخه"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
{
{text = '𝐒𝐔𝐎𝐔𝐑𝐂𝐄 𝐒??𝐃', url="t.me/hms_00"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
