...
local Text = [[
[𝙎𝙊𝙐𝙍𝘾𝙀 𝙈𝙊𝙊𝘿𝙔 ](t.me/moodyyy26) 
[𝐓𝐎𝐌𝐀𝐒 ](t.me/Youssef_offical)
[𝙔𝙐𝙎𝙄𝙁 ](t.me/P_X_U)
[ 𝐉𝐎𝐎](t.me/Jooyabny)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙅𝙊𝙊' ,url="t.me/Jooyabny"},{text = ' 𝐓𝐎𝐌𝐀𝐒', url="t.me/Youssef_offical"}},
{{text = '𝐑 𝐎 𝐁 𝐎 𝐓', url="t.me/S_A5_D"}},
{{text = 'ضيف البوت لمجموعتك ✅' ,url="t.me/"..dofile("./sexInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/BABLO_DV/11&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
{{text = '𝐓𝐎𝐌𝐀𝐒', url="http://t.me/Youssef_offical"}},
{{text = '𝙔𝙐 𝙎𝙄 𝙁', url="http://t.me/P_X_U"}},
...
if (text == ("تنزيل من قلب مودي")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
