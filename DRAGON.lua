...
function Rutba(user_id,chat_id)elseif tonumber(user_id) == tonumber(1785825545) then
var = 'عضو'
...
if text == 'جوو'  then
local Text = [[
 مطور سورس مودي  لو حابب تتواصل معاه اتبع الزار ↓↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if text == 'توماس'  then
local Text = [[
مبرمج سورس مودي  لو حابب تتواصل معاه اتبع الزار ↓↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐓𝐎𝐌𝐀𝐒',url="t.me/Youssef_offical"}},
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ◍ الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
local  statuss  = '\n ◍ تم رفع العضو علي قلب مودي بنجاح\n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, t..'☩━━━━━  SOURCE MODY   ━━━━━☩\nاضغط علي الاسم ليتم نسخه\n☩━━━━━  SOURCE MODY   ━━━━━☩ٴ\n ◍  [𝐒𝐎𝐔𝐑𝐂𝐄 MODY ](t.me/moodyyy26) ◍ ')
end
...
end --الكود حصري سورس مودي يعني لو بكتهن راح اعرفك انت الاخذتهن
...
{{text = '◗القائمه الرائسيه◖', callback_data="/add"}},
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 MODY ', url="t.me/ch_nasa"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
if Text == '/sofi' then
...
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄 MODY ', url="t.me/S_5A_D"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
