...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/YUUISF/robot/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1204848577,1860114886,1785825545,1755371321,1755371321}   
...
if tonumber(user_id) == tonumber(1204848577) then  
var = true 
elseif tonumber(user_id) == tonumber(1785825545) then
var = true  
elseif tonumber(user_id) == tonumber(1755371321) then
var = true  
elseif tonumber(user_id) == tonumber(1755371321) then
var = true  
...
local UserName = (data.username_ or "Uii5_5")
...
local bl = '›'
local keyboard = {
{'قسم الايمان','قسم الالعاب'},
{'قسم الفرفشةة','قسم النعنشةة'},
{'التلفزيون','قسم الرعب'},
{'قسم السورس','قسم المطورين'},
}
...
local bl = '- اختر من الازار بالاسفل . . 🌚❤️'
local keyboard = {
{'قسم الايمان','قسم الالعاب'},
{'قسم الفرفشةة','قسم النعنشةة'},
{'التلفزيون','قسم الرعب'},
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'سبنجبوب') 
local DRAGON_Msg = { 
...
-------------------------------- كيب الاعضاء --------------------------------
if text == 'قسم الايمان' then
local Text = 'مرحبا بك في قسم الايمان . . .🥺√'
local Key = {
{'الاذان','ادعيه'},
...
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == 'قسم الرعب' then
local Text = 'مرحبا بك في قسم الرعب عزيزي . . .🌝🏋️'
local Key = {
{'صور رعب','افلام رعب'},
{'قصص رعب'},
{'العوده'},
...
local Text = 'مرحبا بك في قسم الالعاب . . .🌚√'
local Key = {
...
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == 'كرومبو' then
local Text = 'اختر من الازار بالاسفل . .🏋️🌚'
local Key = {
{'كيفيه اللعب','ابدا اللعب'},
{'شرح اللعبه','العوده'},
}
send_inline_key(msg.chat_id_,Text,Key)
end 
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == 'رجوع للبدايه' or text == 'رجوع.'  then  
local bl = '- اختر من الازار بالاسفل . . 🌚❤️'
local keyboard = {
{'قسم الايمان','قسم الالعاب'},
{'قسم الفرفشةة','قسم النعنشةة'},
...
if text == 'مريم' then
local Text = 'اختر من الازار بالاسفل. .💀😶'
local Key = {
{'الثالث','الثاني','الاول'},
...
if text == 'الاول' then
local Text = 'لو انت جاهز اختر من الازار بالاسفل'
local Key = {
{'لا لسه','جاهز'},
{'رجـوع','الغاء'},
{'الثاني'},
...
if text == 'الثاني' then
local Text = 'انا اسمي مريم وانا مش عارفه اروح ممكن تساعدني؟؟'
local Key = {
{'no','yes'},
{'رجـوع','الثالث'},
{'رجوع للبدايه'},
...
if text == 'الثالث' then
local Text = 'بص يعمو انا بابا اتوفي في حدثه وماما كمان وانا عايشه لوحدي ممكن افضل معاك؟؟'
local Key = {
{'مش موافق','موافق'},
{'رجـوع','الرابع'},
{'رجوع للبدايه'},
...
if text == 'الرابع' then
local Text = 'ممكن انام معاكي فالاوضه ومش هعمل اي صوت'
local Key = {
{'NO','YUS'},
{'رجـوع','الخامس'},
{'رجوع للبدايه'},
...
if text == 'الخامس' then
local Text = 'ممكن يعمو اخد السكينه؟؟'
local Key = {
{'ماشي°','لا °'},
{'رجـوع','السادس'},
{'رجوع للبدايه'},
...
if text == 'السادس' then
local Text = 'هل تستطيع الخروج من المنزل لمقابلتي الساعة 12منتصف الليل'
local Key = {
{'مش هقدر','هقدر'},
{'رجـوع','السابع'},
{'رجوع للبدايه'},
...
if text == 'السابع' then
local Text = 'هتجيب السكينه وتوعر بيها نفسك ومتقولش لحد نك بتنزف'
local Key = {
{'لا طبعا','بعدين'},
{'رجـوع','الثامن'},
{'رجوع للبدايه'},
...
if text == 'الثامن' then
local Text = 'تقدر تعمل قطنك ف اي مكان فجسمك ومش هتحس بحاجه'
local Key = {
{'هجرب','خايف'},
{'رجـوع','التاسع'},
{'رجوع للبدايه'},
...
--------------------------------------------------------
if text == 'ابدا اللعب' then
local Text = 'يمكنك التنقل بين الاقسام بواسطه الزااير. .🥺🙄'
local Key = {
{'القسم الثاني ','القسم الاول'},
...
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == 'القسم الاول' then
local Text = 'اهلا بك انت فالقسم الاول الخاص من اللعبه'
local Key = {
{'اجابه اللغز الاول ','اللغز الاول'},
{'اجابه اللغز الثاني','اللغز الثاني'},
{' اجابه اللغز الثالث','اللغز الثالث'},
{' اجابه اللغز الرابع ',' اللغز الرابع'},
{'رجوع ','الاجابه'},
}
send_inline_key(msg.chat_id_,Text,Key)
end 
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == 'القسم الثاني' then
local Text = 'اهلا بك انت فالقسم الاصعب من اللعبه'
local Key = {
{'اجابه اللغز الخامس ','اللغز الخامس'},
{'اجابه اللغز السادس','اللغز السادس'},
{' اجابه اللغز السابع ','اللغز السابع'},
{' اجابه اللغز الثامن',' اللغز الثامن'},
{'رجوع ','الاجابه'},
...
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == 'القسم الثالث' then
local Text = 'اهلا بك انت فالقسم الاكثر صعوبه من اللعبه'
local Key = {
{'اجابه اللغز التاسع ','اللغز التاسع'},
{'اجابه اللغز العاشر ','اللغز العاشر'},
{' اجابه اللغز الاحدي عشر','اللغز الاحدي عشر'},
{' اجابه اللغز الاثني عشر ',' اللغز الاثني عشر'},
{'رجوع ','الاجابه'},
}
send_inline_key(msg.chat_id_,Text,Key)
end 
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == 'القسم الرابع' then
local Text = 'انت جمدفشخ. .😹🏋️'
local Key = {
{'اجابه اللغز الثالث عشر ','اللغز الثالث عشر'},
{'اجابه اللغز الرابع عشر ','اللغز الرابع عشر'},
{' اجابه اللغز الخامس عشر','اللغز الخامس عشر'},
{' اجابه اللغز السادس عشر ',' اللغز السادس عشر'},
{'رجوع ','الاجابه'},
}
send_inline_key(msg.chat_id_,Text,Key)
end 
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == 'بوتات سبونج' then
local Text = 'مرحبا بك في قسم المساعدةة . . .🏋️🌝'
local Key = {
{'الحذف','المسابقه'},
{'اليوتيوب','التيك توك'},
{'العوده'},
...
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == 'قسم الفرفشةة' then
local Text = 'مرحبا بك في قسم الفرفشةة . . .🤸🐾'
local Key = {
{'تويت','صراحه'},
{'نكته بالصور','نكته'},
{'حروف بالصور','حروف'},
{'لو خيروك بالصور','لو خيروك'},
{'العوده'},
}
send_inline_key(msg.chat_id_,Text,Key)
end 
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == 'قسم النعنشةة' then
local Text = 'مرحبا بك في قسم النعنشةة . . .🥺🏋️'
local Key = {
{'رمزيات ولاد','رمزيات بنات'},
{'رمزيات كبلز','صور انيمي'},
{'استوري','مهنتي','غنيلي'},
{'اسكرينات','باد'},
{'العوده'},
}
...
local Text = 'مرحبا بك اختر من الاوامر بالاسفل'
local Key = {
{'قناة السورس','عايز بوت'},
{'التواصل','سعر التنصيب'},
{'العوده'},
}
send_inline_key(msg.chat_id_,Text,Key)
...
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == 'التلفزيون' then
local Text = 'قسم التلفزيون اختار من الازار بالاسفل . . .🤸🥺'
local Key = {
...
local bl = '- اختر من الازار بالاسفل . . 🌚❤️'
local keyboard = {
{'معلومات السورس ','معلومات البوت'},
{'مسح واضف','تفعيل وتعطيل'},
{'قسم الاذاعه ','قسم الحمايه'},
}
send_inline_key(msg.chat_id_,bl,keyboard)
end
end
...
os.execute('wget https://raw.githubusercontent.com/YUUISF/robot/main/DRAGON.lua')
...
local Text ='🐣╖⁩ مرحبا بك في سورس اسبنجبوب\n💎╢ انت هنا المطور الاساسي\n🎗️╢ يمكنك التحكم فالبوت من الازار \n🦠╜ سورس اسبنجبوب الاول عل التلجرام\n'
keyboard = {} 
keyboard.inline_keyboard = {
...
------------------------------ بدايه كيب المطور -------------------------------
if text == 'معلومات البوت' and DevSoFi(msg) then 
local Text = 'مرحبا فك في ملعومات البوت . . 🥺√'
local Key = {
{'الاحصائيات','ضع اسم للبوت'},
{'الاصدار','المطور'},
{'جلب المشتركين','جلب نسخه'},
...
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == 'معلومات السورس' and DevSoFi(msg) then 
local Text = 'مرحبآ بك عزيزي فقسم معلومات السورس . .🌚√'
local Key = {
{'قناه السورس','التواصل'},
{'تحديث السورس','المطورين'},
{'معلومات السيرفر','تحديث'},
{'العوده'},
}
send_inline_key(msg.chat_id_,Text,Key)
end 
...
local Text = 'مرحبا بك فقسم الحمايه الخاص بك . . 🙂💛'
local Key = {
{'المطورين ','قائمه العام'},
{'الردود العامه','الكتم العام'},
{'تنظيف المشتركين ','الثانوين'},
{'تنظيف الجروبات','تغير الاشتراك'},
...
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == 'مسح واضف' and DevSoFi(msg) then 
local Text = 'مرحبا بك قسم الاضافه والمسح. .🙂✓'
local Key = {
...
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == 'تفعيل وتعطيل' and DevSoFi(msg) then 
local Text = 'مرحبا بك فقسم التفعيل والتعطيل الخاص بك. .⚡√'
local Key = {
...
local Text = 'مرحبا بك فقسم الاذاعات. . 🏋️√'
local Key = {
...
send(msg.chat_id_, msg.id_,' • احدث اصدار من سورس سبنجبوب ')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس⚙', url="t.me/S_A5_D"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
local Text = [[ 
[قناه السورس يعسل. . .√🥺](t.me/Uii5_5)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙋𝙊𝙉𝙂𝙀 ', url="t.me/Uii5_5"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 • من أحسن السورسات على التليجرام سورس سبنجبوب • 
...
if text == ("الكتم العام") and SudoBot(msg) then
...
if text == 'جلب نسخه' and DevSoFi(msg) then 
GetFile_Bot(msg)
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "سبنجبوب")
...
send(msg.chat_id_,0," • الـعـضو  : {["..data.first_name_.."](T.ME/Uii5_5)}\n • ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " • عذرا  ↚ {["..data.first_name_.."](T.ME/Uii5_5)}\n • عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
sendText(msg.chat_id_,'\n • مـن قبـل ↭ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n • تم تفعيل البوت في الـجروب {'..chat.title_..'}\n  تم تـرقيه جـمـيع الادمنةةه',msg.id_/2097152/0.5,'md')
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' • تم تفعيل البوت في الـجروب ')
else
sendText(msg.chat_id_,'\n • مـن قبـل ↭ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n • تم تفعيل البوت في الـجروب {'..chat.title_..'}\n  تم تـرقيه جـمـيع الادمنةةه •',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
Text = ' • مرحبآ عزيزي تم تشغيل البوت فـي جروب جديد ↓↓\n'..
'\n🦐 ╖⁩ بواسطة {「'..Name..'」}'..
...
local Text = {
  "الواد د هقر غير اسمه؟🙂 ",
"عفكره الاسم القديم كان احلي",
"جمد اسمك الجديد د",
}
...
local Text = {
'يساتر يرب غيرت معرفك ليه؟',
"الواد د هقر غير معرفه؟🙂",
"اتخانقت مع مين علشان تغير معرفك؟🌚",
...
local Text = {
  "غيرت صورتك ليه؟🌚 ",
  "الواد د هقر غير صورته🙂",
  "جامده الصوره الجديده دي",
  "الواد د هقر كل شويه يغير صورته",
}
send(msg.chat_id_, msg.id_,Text[math.random(#Text)])
end  
...
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == 'عاوز سورس' or text == 'سورس' or text == 'يا سورس' or text == 'سورس مين ده' then
local Text = [[
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
🎗╎ 𝚆𝚎𝚕𝚌𝚘𝚖𝚎 𝚍𝚎𝚊𝚛 
🚶‍♂╎𝚃𝙷𝙴 ??𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙸𝙽 𝚃𝙴𝙻𝙶𝚁𝙰𝙼
🧶╎ 𝚂𝚃𝚁𝙻𝚅𝙴 𝙵𝙾𝚁 𝚃𝙷𝙴 𝙱𝙴𝚂𝚃
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
──┈┈┈┄┄╌╌╌╌┄┄┈┈┈
•  𝖼𝗁 - [𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙿𝙾𝙽𝙶𝙴.](t.me/Uii5_5)
──┈┈┈┄┄╌╌╌╌┄┄┈┈┈
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ᗯOᒪᖴᗩᖇEᑎ' ,url="t.me/Wolfareenn"},{text = 'YᑌᔕIᖴ ', url="t.me/U_1_X_U"}},
{{text = ' 𝚁. 𝙾𝙱𝙾𝚃', url="t.me/S_A5_D"}},
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙿𝙾𝙽𝙶𝙴 ', url="t.me/Uii5_5"}},
{{text = 'اضف البوت لمجموعتك ✅' ,url="t.me/"..dofile("./sexInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/U_AFLAM/25&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == 'السورس' or text == 'قناه السورس' or text == 'سورس جامد' or text == 'بوت مين ده' then
local Text = [[
[𝙏𝙃𝙀 𝘽𝙀𝙎𝙏 𝙎𝙊𝙐𝙍𝘾𝙀 𝙏𝙀𝙇𝙀𝙂𝙍𝘼𝙈](t.me/Uii5_5) 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝚈𝚄𝙾𝚂𝙸𝙵' ,url="t.me/U_1_X_U"},{text = '𝚆𝙾𝙻𝙵𝙰𝚁𝙴𝙽', url="t.me/Wolfareenn"}},
{{text = '𝚁. 𝙾𝙱𝙾𝚃', url="t.me/S_A5_D"}},
{{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙋𝙊𝙉𝙂𝙀 ', url="t.me/Uii5_5"}},
{{text = 'اضف البوت لمجموعتك ✅' ,url="t.me/"..dofile("./sexInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/U_AFLAM/24&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
...
{{text = 'ᗯOᒪᖴᗩᖇEᑎ', url="http://t.me/Wolfareenn"}},
{{text = 'YᑌᔕIᖴ',url="t.me/U_1_X_U"}},
{{text = '𝙍. 𝙊𝘽𝙊𝙏 ', url="http://t.me/P_X_U"}},
}
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))  
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ᗯOᒪᖴᗩᖇEᑎ  ' ,url="t.me/Wolfareenn"},{text = 'YᑌOᔕIᖴ', url="t.me/U_1_X_U"}},
{{text = 'ᖇOᗷOT', url="t.me/S_A5_D"}},
{{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙋𝙊𝙉𝙂𝙀 ', url="t.me/Uii5_5"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/U_AFLAM/21&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'روبت' or text == 'يوسف روبت' or text == 'روبت راجع' then
...
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == 'سعر التنصيب' or text == 'بكام البوت' or text == 'DRAGON' then
local Text = [[
──┈┈┈┄┄╌╌╌╌┄┄┈┈┈
🐣╖⁩  مرحبا عزيزي لتنصيب بوتك 
✨╢ عل اسبنجبوب عليك اتباع ما يلي
🎀╢ تواصل مع احد مطورين السورس
⬆️╜ التنصيب مجاني لفتره محدوده
──┈┈┈┄┄╌╌╌╌┄┄┈┈┈
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/U_AFLAM/50&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == 'شرح اللعبه' or text == 'ام البوت' or text == 'DRAGON' then
local Text = [[
──┈┈┈┄┄╌╌╌╌┄┄┈┈┈
🪡╖⁩ كرومبو هي شخصية كارتونية ابتكرها احمد
🍯╢ صاحب شركة بانوراما للإنتاج الاعلاميه
🥁╢ واستطاعت أن تحقق نجاحا ونجومية على
⚙╢ العالم العربي وينتظرها الملايين للإجابة عن
🎀╢ أسئلة المسابقة التي تعتمد على الكوميديا
⬆️╜ أسئلة المسابقة التي تعتمد على الكوميديا
──┈┈┈┄┄╌╌╌╌┄┄┈┈┈
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/U_AFLAM/65&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
...
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == 'التيك توك'  then
local Text = [[
======{ @K0XBOT }======
W𝘌𝘓𝘊𝘖𝘔𝘌 𝘛𝘖 𝘛𝘏𝘌 𝘛𝘐𝘒 𝘛𝘖𝘒 𝘉𝘖𝘛 𓏶 
يمكنك الان تحميل الفيديو الذي يعجبك من ع التيك توك بدون علامه مائيه 🌝✌️
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝘛𝘐𝘒 𝘛𝘖𝘒 𝘉𝘖𝘛',url="t.me/K0XBOT"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/U_AFLAM/29&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == 'الحذف'  then
local Text = [[
======{ @LC6BOT }======
W𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐓𝐇𝐄 𝐃𝐄𝐋𝐄𝐓𝐄 𝐁𝐎𝐓 𖢒  
يمكنك الان حذف حسابك بكل سهوله 
____| SOURCE SPONGE |____
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐃𝐄𝐋𝐄𝐓𝐄 𝐁𝐎𝐓 ',url="t.me/LC6BOT"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/U_AFLAM/32&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == 'المسابقه'  then
local Text = [[
======{ @Mosabka5bot }======
W𝙚𝙡𝙘𝙤𝙢𝙚 𝙩𝙤 𝙩𝙝𝙚 𝙘𝙤𝙣𝙩𝙚𝙨𝙩 𝙗𝙤𝙩 ⶄ 
ما عليك سوي رفع البوت مشرف في القناه 
وتكتب اسماء المتسابقين ف القناه 
____| SOURCE SPONGE |____
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙘𝙤𝙣𝙩𝙚𝙨𝙩 𝙗𝙤𝙩',url="t.me/Mosabka5bot"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/U_AFLAM/34&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == 'صانع السعادةة'  then
local Text = [[
مطور سورس سبنجبوب لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text ='𝒀𝑶𝑼𝑺𝑬𝑭  ',url="t.me/U_1_X_U"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/U_AFLAM/10&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == 'توماس'  then
local Text = [[
...
if text == '𝑅. 𝑂𝐵𝑂𝑇'  then
local Text = [[
مبرمج سورس سبنجبوب لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text =' 𝙍. 𝙊𝘽𝙊𝙏 ',url="t.me/S_A5_D"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/U_AFLAM/12&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == '𝑊𝑂𝐿𝐹𝐴𝑅𝐸𝑁'  then
local Text = [[
مطور سورس سبنجبوب لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text ='  𝑊𝑂𝐿𝐹𝐴𝑅𝐸𝑁  ',url="t.me/Wolfareenn"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/U_AFLAM/8&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == 'حسام'  then
local Text = [[
...
if text == 'كرومبو'  then
local Text = [[
مرحبا بك في لعبه كرومبو هيا لنبدا . .🥺√
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙋𝙊𝙉𝙂𝙀 ', url="t.me/Uii5_5"}},
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/U_AFLAM/61&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == 'يوتيوب' or text == 'يتيوب' or text == 'اليوتيوب' then
local Text = [[
======{ @Qeaa_bot }======
W𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐓𝐇𝐄 𝐘𝐎𝐔𝐓𝐔𝐁𝐄 𝐁𝐎𝐓 𝅘𝅥𝅯  
يمكنك الان التحميل من اليوتيوب مباشرة
_____| SOURCE SPONGE |____
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐘𝐎𝐔𝐓𝐔𝐁𝐄 𝐁𝐎𝐓',url="t.me/Qeaa_bot"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/U_AFLAM/28&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
...
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == "تويت" or text == "اسئله" then 
local TWEET_Msg = { 
"مرتبط؟ ", 
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس سبنجبوب؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس سبنجبوب؟ ", 
"كم مره حبيت؟ ", 
...
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == "تحليل" or text == "اسئله عميقه" then 
local TWEET_Msg = { 
"كيف تصف نفسك؟؟ ",
"ما هو اكبر انجاز فحياتك؟؟ ",
" كيف تكون صلتك بالله ",
" ما رايك فمعني الحياه ",
"اي اكتر حجه بتكرها فنفسك ",
"هل لديك مشكله مع نفسك ",
" أن كنت تستطيع فعل شيء لبقية حياتك، فماذا سوف يكون؟ ",
"هل تظن أنك شجاع ام العكس؟ ",
"ما هو الشيء الذي يجعلك تظن أنك محبوب جداً من قبل الجميع؟ ",
"إن أمكنك تغير أسمك، فأي أسم ستختار لنفسك؟ ",
"ما هو الشيء الموجود في حياتك يجعلك تشعر بأنك لاتزال على قيد الحياة؟",
"إن كان المال بالنسبة لك هو السعادة، فما هي الوظيفة التي ستختارها لتحقيق ذلك؟ ",
"هل تتمسك بشيء بينما يجب عليك التخلي عنه؟ ",
"إن كان هناك مواقف تدفعك إلي الكذب، فما هي؟ ",
"هل تفضل العمل بمفردك ام مع الأخرين؟ ",
"عندما تشعر بالفرح أو بالحزن، من هو أول شخص تفكر به وتريد مشاركة مشاعرك معه؟ ",
"اين تريد أن تكون بعد أربعة سنوات من الاَن؟ ",
"هل هناك شخص ما تريد أن تكون معه للأبد؟ ",
"ما هو أسوأ شيء مررت به عندما كنت طفل صغير ",
"ما هو الشيء الوحيد فقط الذي ترغب في القيام به؟ ",
"كيف تعبر عن غضبك؟ ",
"إن كنا نتعلم من أخطاءنا ، فلماذا نخاف دائما من إرتكابها؟ ",
"ما هي أهم لحظة في حياتك بالكامل حتي وقتنا هذا؟ ",
"ما هي أفضل ذكرة لك من أيام الطفولة؟",
"ما هو الشيء الذي لا يشتريه المال؟ ",
"إلي أي درجة تحكمت في مسار حياتك الذي سلكته حتي الاَن؟",
"ما هم القيم الشخصية الخمس الهمه لديك؟",
"ما هي طريقة وصفك للحرية؟",
"كم عدد أصدقائك الحقيقين الذين تثق بهم حقاً في حياتك؟",
} 
send(msg.chat_id_, msg.id_,'['..TWEET_Msg[math.random(#TWEET_Msg)]..']')  
return false 
end
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/y_giut/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙋𝙊𝙉𝙂𝙀 ](t.me/Uii5_5)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙋𝙊𝙉𝙂𝙀 ', url="t.me/U_SPONG"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BABLO_DV/69&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == 'العاب سبنجبوب' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 • اهلا في قائمه الالعاب المتطوره سورس سبنجبوب • 
...
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == "سكس" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(4,50); 
local Text ='اكتب سكس وسيتم اختيار لك فيديو جمد' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'اضف البوت لمجموعتك ✅' ,url="t.me/"..dofile("./sexInfo.lua").botUserName.."?startgroup=start"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/sex5ex/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == "سقس" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(4,50); 
local Text ='اكتب سكس وسيتم اختيار لك فيديو جمد' 
keyboard = {}  
keyboard.inline_keyboard = { 
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/jdjie13/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/sjsj38/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "صراحه بصور" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(1,28); 
...
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == "انمي" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(1,28); 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/vvvvvvvvvag/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
...
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == "رمزيات كبلز" or text ==  "صور كابلز"  and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
...
ght = math.random(1,28); 
local Text ='اكتب رمزيات واستمتع باجمد الصور' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'اضف البوت لمجموعتك ✅' ,url="t.me/"..dofile("./sexInfo.lua").botUserName.."?startgroup=start"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/rrrrttttrr/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
...
if tonumber(result.sender_user_id_) == tonumber(1204848577) then  
send(msg.chat_id_, msg.id_, " • لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1755371321) then  
send(msg.chat_id_, msg.id_, " • لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1755371321) then  
...
function(arg,data) 
usertext = '\n • الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'Uii5_5')..')'
...
if result.id_ == tonumber(1204848577) then
send(msg.chat_id_, msg.id_, " • لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1755371321) then
send(msg.chat_id_, msg.id_, " • لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1755371321) then
...
usertext = '\n • الـعـضو   ↚ ['..result.title_..'](t.me/'..(username or 'Uii5_5')..')'
status  = '\n • تم حظرو عام من الجروبات '
texts = usertext..status
...
if tonumber(userid) == tonumber(1204848577) then  
send(msg.chat_id_, msg.id_, " • لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(1755371321) then  
send(msg.chat_id_, msg.id_, " • لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(1755371321) then  
...
if text == ("م") and DevSoFi(msg) then
local list = database:smembers(bot_id..'Sudo:User')
t = "\n • قائمة مطورين البوت \n☩━━━━━ 𝑆𝑃𝑂𝑁𝐺𝐸 ━━━━━☩\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/YUUISF/robot/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n • اهلا بك في متجر ملفات سبنجبوب\n • ملفات السورس ↓\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n☩━━━━━ 𝑆𝑃𝑂𝑁𝐺𝐸 ━━━━━☩\n • علامة تعني { ✔️ } ملف مفعل\n • علامة تعني { ✖ } ملف معطل\n • قناة سورس سبنجبوب↓\n".." • [اضغط هنا لدخول](t.me/Uii5_5) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/YUUISF/robot/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," • عذرا الملف لايدعم سورس سبنجبوب\n") 
end
return false
end
...
if text == ("مسح قائمه سبنجبوب") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n • تم مسح قائمه سبنجبوب')
return false
end

if text == 'قائمه سبنجبوب' and Sudo(msg) then
...
if #list == 0 then
t = " • لا يوجد احد في قائمه سبنجبوب"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع سبنجبوب") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع سبنجبوب@(.*)$") and Sudo(msg) then
local username = text:match("^رفع سبنجبوب@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع سبنجبوب(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع سبنجبوب(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل سبنجبوب") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل سبنجبوب@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل سبنجبوب@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل سبنجبوب(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل سبنجبوب(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("ث") and SudoBot(msg) then
local list = database:smembers(bot_id.."Dev:SoFi:2")
t = "\n • قائمة مطورين الثانويين للبوت \n☩━━━━━ 𝑆𝑃𝑂𝑁𝐺𝐸 ━━━━━☩\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
...
send(msg.chat_id_, msg.id_, t..'☩━━━━━ 𝑆𝑃𝑂𝑁𝐺𝐸 ━━━━━☩\nاضغط علي الاسم ليتم نسخه\n☩━━━━━ 𝑆𝑃𝑂𝑁𝐺𝐸 ━━━━━☩ٴ\n • [𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙋𝙊𝙉𝙂𝙀 ](t.me/Uii5_5) • ')
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'سبنجبوب').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'سبنجبوب')
local DRAGON_Msg = {
'ننعم يروحي 😻??',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/BABLO_DV/42&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/BABLO_DV/33&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/BABLO_DV/44&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/BABLO_DV/38&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/BABLO_DV/32&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/BABLO_DV/31&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/BABLO_DV/48&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙋𝙊??𝙂𝙀 ', url="t.me/Uii5_5"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/BABLO_DV/42&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/BABLO_DV/49&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/BABLO_DV/52&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/BABLO_DV/53&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/BABLO_DV/55&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/BABLO_DV/56&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/BABLO_DV/57&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙎𝙊𝙐𝙍??𝙀 𝙎𝙋𝙊𝙉𝙂𝙀 ', url="t.me/Uii5_5"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/BABLO_DV/57&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/BABLO_DV/58&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'بموت فيكي' then
local Text = [[
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
end --الكود حصري سورس سبنجبوبيعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سبنجبوب').." غادر" or text == 'غادر' then  
...
if text == 'تيست' or text == 'تيستت' then
send(msg.chat_id_,msg.id_, '◉ يبني وربي شغال') 
return false
end
...
if text == 'تيست' or text == 'تسيت' then
send(msg.chat_id_,msg.id_, '◉ ولد عبب..🙂👍') 
return false
end

if text == 'كيفيه اللعب' or text == 'كيف اللعب' then
send(msg.chat_id_,msg.id_, 'في البدايه اختار بدا اللعب ثم اختار من الازار بالاسفل وضع اجباتك ان لم تعرف الاجابه ف اضغط عل الاجابه') 
return false
end
------------- القسم الاول ---- -------------
if text == 'اللغز الاول' then 
send(msg.chat_id_,msg.id_, '   اللغز الأول: دعت سيدة صديقة لها لتناول العشاء معا في المنزل، وجهزت لاستقبالها بطاطس مهروسة ولحم مشوي وحلوى، ثم قامت السيدة بقطع تفاحة إلى نصفين، وقدمت لصديقتها أولاً نصف تفاحة مع بعض من الكريمة المخفوقة، ثم وضعت المتبقي من الكريمة في وعاء منفصل، ولكن توفت صديقتها وجاء تقرير الطب الشرعي أنها ماتت مسمومة، فكيف ماتت الصديقة والسيدة التي دعتها لمنزلها مازالت على قيد الحياة؟  ') 
return false
end

if text == 'اجابه اللغز الاول' then 
send(msg.chat_id_,msg.id_, '    الإجابة: السم كان في الكريمة فوق نصف التفاحة التي أكلتها الصديقة. ') 
return false
end

if text == 'اللغز الثاني' then 
send(msg.chat_id_,msg.id_, '  اللغز الثاني: ذهب صديقين إلى رحلة لتسلق الجبال، ولكن عاد شخص واحد من الرحلة والثاني انزلق من على الجبل ومات، وبعد التحقيقات ألقت الشرطة القبض على الشخص الذي نجا وقالت إنهم تلقوا مكالمة من الشركة المنظمة للرحلة وتأكدوا أنه المذنب على الرغم أن هذا الشخص لم يبلغ أحد بالرحلة، فكيف عرفوا الجريمة؟   ') 
return false
end

if text == 'اجابه اللغز الثاني' then 
send(msg.chat_id_,msg.id_, '   الإجابة: قام الشخص الذي نجا بحجز تذكرتين ذهاب إلى الرحلة وتذكرة عودة واحدة.  ') 
return false
end

if text == 'اللغز الثالث' then 
send(msg.chat_id_,msg.id_, '  اللغز الثالث: يعيش رجل غني معاق عن الحركة وحيدًا في كوخ صغير وكان يعتمد دائما على خدمات التوصيل لتلبية احتياجاته، وجاء يوم ساعي البريد لتسليمه البريد ولكن لاحظ الساعي أن باب الكوخ كان مفتوحًا ووجد الرجل غارقًا في دمائه، جاءت الشرطة للفحص ووجدت زجاجتين من اللبن وصحيفة لـ 4 أيام مضت ووجدت أيضًا كتالوج وبريد غير مفتوح على الشرفة، وصرحت الشرطة بعدها أن ساعي البريد هو القاتل، فكيف استطاعوا معرفة ذلك؟   ') 
return false
end

if text == 'اجابه اللغز الثالث' then 
send(msg.chat_id_,msg.id_, 'الإجابة: عدم وجود جرائد لمدة 4 أيام كان الدليل على أن ساعي البريد كان يعلم بمقتل الرجل ولذلك لم يحضرها له.') 
return false
end

if text == 'اللغز الرابع' then 
send(msg.chat_id_,msg.id_, '   كان هناك رجل يعيش وحيدًا في منزله دائمًا ما يطلب خدمات التوصيل و يصل اليه ساعي البريد كل يوم بالجرائد والمجلات، ولكن تم قتل الرجل فجأة وهو يوجد بجانبه بعض الاغراض وصحيفة منذ يومين، فمن القاتل ؟  ') 
return false
end

if text == 'اجابه اللغز الرابع' then 
send(msg.chat_id_,msg.id_, '  الحل : ساعي البريد هو القاتل، لأن الرجل لم تصل له الجريدة في يوم مقتله.   ') 
return false
end
------------- القسم الاول ---- -------------
if text == 'اللغز الخامس' then 
send(msg.chat_id_,msg.id_, ' لدى إمرأة فتاتان ولدتا في نفس الساعة من نفس اليوم من نفس العام، لكنهما لم يكونا توأم ثنائي، كيف يمكن أن يكون الأمر كذلك؟ الإجابة: كانوا توأم ثلاثي ما هو لون ماء النيل الأزرق؟ ') 
return false
end
if text == 'اجابه اللغز الخامس' then 
send(msg.chat_id_,msg.id_, 'الإجابة عديم اللون. ') 
return false
end

if text == 'اللغز السادس' then 
send(msg.chat_id_,msg.id_, 'ركب رجل قاصدا المدينة على حصانه، وصل يوم الأحد، وأمضى ثلاثة أيام في المدينة وغادر يوم الأحد، كيف يعقل ذلك ') 
return false
end

if text == 'اجابه اللغز السادس' then 
send(msg.chat_id_,msg.id_, 'كان اسم الحصان يوم الأحد. ') 
return false
end

if text == 'اللغز السابع' then 
send(msg.chat_id_,msg.id_, 'كم مرة يمكنك طرح الرقم 5 من 35؟ ') 
return false
end

if text == 'اجابه اللغز السابع' then 
send(msg.chat_id_,msg.id_, ' الإجابة: مرة واحدة يمكنك ذلك، لأن المرة القادمة ستطرح 5 من 30، ثم 5 من 25، وهكذا.') 
return false
end

if text == 'اللغز الثامن' then 
send(msg.chat_id_,msg.id_, 'والدة مينا لديها خمس بنات: رينا، تينا، شينا وشيلا، من هي الابنة الخامسة؟ ') 
return false
end

if text == 'اجابه اللغز الثامن' then 
send(msg.chat_id_,msg.id_, ' الإجابة: مينا.') 
return false
end
---------- ------------------------------
if text == 'اللغز التاسع' then 
send(msg.chat_id_,msg.id_, ' إذا كان قطار كهربائي يتجه لليسار وهو قادم من الجنوب، فأين سيكون اتجاه دخانه؟ يسار أم يمين؟')
return false
end

if text == 'اجابه اللغز التاسع' then 
send(msg.chat_id_,msg.id_, ' ما دام أن القطار كهربائي فهم يعمل بالكهرباء ولا يخرج منه أي دخان.') 
return false
end

if text == 'اللغز العاشر' then 
send(msg.chat_id_,msg.id_, ' رجل لديه 53 جورب كالتالي 21 لونهم أزرق و15 أسود و 17 أحمر، الغرفة مظلمة وعليه أن يخرج بزوجين من الجوارب السود، فكم عدد الجوارب التي يجب أن يأخذها للتأكد من أن لديه زوجًا واحدًا على الأقل من الجوارب السوداء؟') 
return false
end

if text == 'اجابه اللغز العاشر' then 
send(msg.chat_id_,msg.id_, ' الإجابة: 40 جوربا، فإذا قام بإخراج 38 جوربًا، فمن الممكن أن تكون جميعًا زرقاء وحمراء، وللتأكد من أن لديه زوجًا من الجوارب السوداء، يجب عليه أخذ جوربين آخرين.') 
return false
end

if text == 'اللغز الاحدي عشر' then 
send(msg.chat_id_,msg.id_, ' ما يحتوي على مفاتيح ولكن بدون أقفال، مسافة ولكن بدون غرفة، يمكنك الدخول ولكن لا يمكنك الخروج؟') 
return false
end

if text == 'اجابه اللغز الاحدي عشر' then 
send(msg.chat_id_,msg.id_, 'لوحة المفاتيح. ') 
return false
end

if text == 'اللغز الاثني عشر' then 
send(msg.chat_id_,msg.id_, ' امرأة تجلس في غرفتها في الليل، ليس لديها أضواء، ولا شمع، ولا مصباح، ولا ضوء على الإطلاق، ومع ذلك فهي تقرأ، كيف ذلك؟ الإجابة: تقرأ بطريقة برايل. غالبًا ما أجري ولكن ليس لدي أرجل، أنت بحاجة لي لكنني لست بحاجة إليك، ما أنا؟') 
return false
end

if text == 'اجابه اللغز الاثني عشر' then 
send(msg.chat_id_,msg.id_, 'الإجابة: الماء ') 
return false
end
------------------------------
if text == 'اللغز الثالث عشر' then 
send(msg.chat_id_,msg.id_, 'كان هناك رجل يعيش وحيدًا في منزله دائمًا ما يطلب خدمات التوصيل و يصل اليه ساعي البريد كل يوم بالجرائد والمجلات، ولكن تم قتل الرجل فجأة وهو يوجد بجانبه بعض الاغراض وصحيفة منذ يومين، فمن القاتل ؟ ') 
return false
end

 if text == 'اجابه اللغز الثالث عشر' then 
send(msg.chat_id_,msg.id_, ' الحل : ساعي البريد هو القاتل، لأن الرجل لم تصل له الجريدة في يوم مقتله.') 
return false
end

if text == 'اللغز الرابع عشر' then 
send(msg.chat_id_,msg.id_, ' ذهب اثنين من الاصدقاء الى رحلة للشاطئ، فغرق واحد منهم والثاني نجا، ولكن بعد فترة قامت الشركة المنظمة للرحلة بتقديم دليل للشرطة انها كانت جريمة قتل وان الشخص الاول لم يغرق، فمن القاتل، وما هو الدليل الذي قدمته الشركة ؟') 
return false
end

if text == 'اجابه اللغز الرابع عشر' then  
send(msg.chat_id_,msg.id_, ' الحل : القاتل هو الصديق الأخر، والدليل على ذلك انه هو من قام بحجز تذاكر الرحلة من الشركة، ولكنه قام  بحجز تذكرتين للذهاب وتذكرة واحدة فقط للعودة.') 
return false
end

if text == 'اللغز الخامس عشر' then 
send(msg.chat_id_,msg.id_, ' يعيش رجل غني معاق عن الحركة وحيدًا في كوخ صغير وكان يعتمد دائما على خدمات التوصيل لتلبية احتياجاته، وجاء يوم ساعي البريد لتسليمه البريد ولكن لاحظ الساعي أن باب الكوخ كان مفتوحًا ووجد الرجل غارقًا في دمائه، جاءت الشرطة للفحص ووجدت زجاجتين من اللبن وصحيفة لـ 4 أيام مضت ووجدت أيضًا كتالوج وبريد غير مفتوح على الشرفة، وصرحت الشرطة بعدها أن ساعي البريد هو القاتل، فكيف استطاعوا معرفة ذلك؟') 
return false
end

if text == 'اجابه اللغز الخامس عشر' then 
send(msg.chat_id_,msg.id_, ' الإجابة: عدم وجود جرائد لمدة 4 أيام كان الدليل على أن ساعي البريد كان يعلم بمقتل الرجل ولذلك لم يحضرها له.') 
return false
end

if text == 'اللغز السادس عشر' then 
send(msg.chat_id_,msg.id_, '  يعيش رجل غني معاق عن الحركة وحيدًا في كوخ صغير وكان يعتمد دائما على خدمات التوصيل لتلبية احتياجاته، وجاء يوم ساعي البريد لتسليمه البريد ولكن لاحظ الساعي أن باب الكوخ كان مفتوحًا ووجد الرجل غارقًا في دمائه، جاءت الشرطة للفحص ووجدت زجاجتين من اللبن وصحيفة لـ 4 أيام مضت ووجدت أيضًا كتالوج وبريد غير مفتوح على الشرفة، وصرحت الشرطة بعدها أن ساعي البريد هو القاتل، فكيف استطاعوا معرفة ذلك؟') 
return false
end

if text == 'اجابه اللغز السادس عشر' then 
send(msg.chat_id_,msg.id_, ' الإجابة: عدم وجود جرائد لمدة 4 أيام كان الدليل على أن ساعي البريد كان يعلم بمقتل الرجل ولذلك لم يحضرها له. ') 
return false
end
------------------------------------------
...
send(msg.chat_id_,msg.id_, '◉ سبنجبوب ورب العباد') 
return false
end
...
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == 'yes' or text == 'yus' then
send(msg.chat_id_,msg.id_, 'شكررا ليك مش عارفه اقولك اي؟؟ 🥺') 
return false
end

if text == 'no' or text == 'noo' then
send(msg.chat_id_,msg.id_, 'ليه كد يعموو هقعد ساكته والله؟؟ 🥺🥺') 
return false
end
...
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == 'لا لسه' then 
send(msg.chat_id_,msg.id_, ' لما تجهز اضعط عل كلمه جاهز ') 
return false
end

if text == 'موافق' then 
send(msg.chat_id_,msg.id_, 'تمام ممكن تقرب مني ') 
return false
end

if text == 'مش موافق' then 
send(msg.chat_id_,msg.id_, 'تمام انا هستنا هنا لحد ماما وبابا ييجو ياخدوني') 
return false
end

if text == 'YUS' then 
send(msg.chat_id_,msg.id_, 'انتي خايفه مني؟') 
return false
end

if text == 'NO' then 
send(msg.chat_id_,msg.id_, 'تمام ') 
return false
end

if text == '.لا' then 
send(msg.chat_id_,msg.id_, 'هخدها يعني هخدها') 
return false
end
if text == 'هقدر' then 
send(msg.chat_id_,msg.id_, 'حسنا هي بنا') 
return false
end
if text == 'مش هقدر' then 
send(msg.chat_id_,msg.id_, 'لو منزلتش سوف تموت اليوم') 
return false
end

if text == 'بعدين' then 
send(msg.chat_id_,msg.id_, '  وتشغل اغاني بصوت عالي وترقص') 
return false
end

if text == 'لا طبعا' then 
send(msg.chat_id_,msg.id_, ' لو معملتش كد اخوك/اختك هتموت النهارده ') 
return false
end

if text == 'ماشي.' then 
send(msg.chat_id_,msg.id_, 'متخفش مش هعملك حجه ') 
return false
end

if text == 'خايف' then 
send(msg.chat_id_,msg.id_, 'لو مش واثق فيا الاشباح هتاخد روحك اليوم ') 
return false
end

if text == 'هجرب' then 
send(msg.chat_id_,msg.id_, 'تمام مستنياك ') 
return false
end

if text == 'مش واثق' then 
send(msg.chat_id_,msg.id_, ' متقلقش هتثق فيا لما تعرف كلامي صح') 
return false
end

if text == 'واثق' then 
send(msg.chat_id_,msg.id_, 'لو واثق فيا هتعور اخوك فوشه وهو نايم ومتقلقش هو مش هيحس بحاجه ') 
return false
end
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text then 
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/Uii5_5)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/Uii5_5)')
return false
end
end
end
...
if text == "نسبه جمالي" or text == "نسبه الجمال"   then
...
if text == "تعطيل السكس" and Mod(msg) then
send(msg.chat_id_, msg.id_, ' • تم تعطيل السكس')
database:set(bot_id.."reply_to_message_id"..msg.chat_id_,"close")
end
if text == "تفعيل السكس" and Mod(msg) then
send(msg.chat_id_, msg.id_,' • تم تفعيل السكس')
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/U_AFLAM/67&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
if text == 'جاهز'  then
local Text = [[
 لا تخف هيا لنبدا لا تصدر اي صوت؟؟
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙋𝙊𝙉𝙂𝙀 ', url="t.me/Uii5_5"}},
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/U_AFLAM/68&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
-------------------------------- 𝙳𝚅. 𝚈𝚄𝚂𝙸𝙵 --------------------------------
...
if text == "نيكه" or text == "افشخه" or text == "حط عليه" or text == "بوت نيكه" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"لف يبنلوسخه","متيجي انيقق ياات","لف","يبنلوسخه بس","انيكه بجد؟","لا بنيك حريم بس","انيك د؟انا قرفان منه اصلن","تعال يبنلمتناكه انا اصلا حيحان","هخ اخيرا هنيك!","قول حاحا ياات","تعال امسك زبي وهديك جنيه😹","اقلعع يبنلوسخه"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
{
{text = '𝐒𝐔𝐎𝐔𝐑𝐂𝐄 𝐒??𝐃', url="t.me/Uii5_5"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
{{text = '◗القائمه الرائسيه◖', callback_data="/add"}},
{{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙋𝙊𝙉𝙂𝙀 ', url="t.me/ch_nasa"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
if Text == '/sofi' then
...
{
{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙋𝙊𝙉𝙂𝙀 ', url="t.me/S_5A_D"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'سبنجبوب')
...
if text and text ~="الاجابه" and database:get(bot_id..":"..msg.sender_user_id_..":rkko_Bots"..msg.chat_id_) == "sendrkkoe" then
numj = {"اجابتك صح بنسبه 10٪💔😔"," اجابتك صح بنسبه 38%"," اجابتك صح بنسبه 10٪🤝😂"," اجابتك صح بنسبه 90٪❤️😁","اجابتك صح بنسبه 7%","لو شاكك ف اجابتك تقدر تتاكد من الكيب بالاسفل😹","اجابتك صح بنسبه 80٪🌚💕","لو شاكك ف اجابتك تقدر تتاكد من الكيب بالاسفل","اجابتك صح بنسبه 0.00%",};
sendnuj = numj[math.random(#numj)]
xl = ' ⟨  '..text..'  ⟩ \n '..sendnuj..'.'
send(msg.chat_id_, msg.id_,xl) 
database:del(bot_id..":"..msg.sender_user_id_..":rkko_Bots"..msg.chat_id_)
end
if text == "الاجابه" or text == "الاجابه عل السوال" and msg.reply_to_message_id_ ~= 0 and Addictive(msg) then
if not database:get(bot_id..'Cick:rkko'..msg.chat_id_) then
database:set(bot_id..":"..msg.sender_user_id_..":rkko_Bots"..msg.chat_id_,"sendrkkoe")
local LEADER_Msg = {
"الاجابه | ارسل اجابتك لتاكد من الاجابه اضغط عل الاجابه + رقم السوال من الاسفل",
"الاجابه | اكتب اجابتك وللتاكد منها اضغط عل الاجابه + رقم اللغز من الاسفل",
}
send(msg.chat_id_, msg.id_,'['..LEADER_Msg[math.random(#LEADER_Msg)]..']') 
return false
end
...
if text and text ~="الاجابه" and database:get(bot_id..":"..msg.sender_user_id_..":rkko_Bots"..msg.chat_id_) == "sendrkkoe" then
numj = {"اجابتك صح بنسبه 10٪💔😔"," ده مظبوط🙂😹"," اجابتك صح بنسبه 10٪🤝😂"," اجابتك صح بنسبه 90٪❤️😁","فعلا بتتكلم صح🤗","لو شاكك ف اجابتك تقدر تتاكد من الكيب بالاسفل😹","اجابتك صح بنسبه 80٪🌚💕","لو شاكك ف اجابتك تقدر تتاكد من الكيب بالاسفل","انت صح",};
sendnuj = numj[math.random(#numj)]
xl = ' ⟨  '..text..'  ⟩ \n '..sendnuj..'.'
send(msg.chat_id_, msg.id_,xl) 
database:del(bot_id..":"..msg.sender_user_id_..":rkko_Bots"..msg.chat_id_)
